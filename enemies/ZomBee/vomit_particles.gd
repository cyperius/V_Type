...
func _process(_delta: float) -> void:
	vomit_particles.look_at(Global.player_ship.global_position)
...
func spawn_vomit_bullet():
	...
	bullet.look_at(Global.player_ship.global_position)
	bullet.global_position = head.global_position
	bullet.velocity = 5000.0 * bullet.global_position.direction_to(Global.player_ship.global_position)# oder andere Geschwindigkeit
